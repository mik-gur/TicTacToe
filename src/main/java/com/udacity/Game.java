...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        String result = "None";
        // implements when "X" wins a game
        if(grid[1][1]=='x' && grid[1][0]=='x' && grid[1][2]=='x' ||
           grid[1][1]=='x' && grid[0][1]=='x' && grid[2][1]=='x' ||
           grid[1][1]=='x' && grid[0][0]=='x' && grid[2][2]=='x' ||
           grid[1][1]=='x' && grid[0][2]=='x' && grid[2][0]=='x' ||
        ...
        // implements when "O" wins a game
        else if(grid[1][1]=='o' && grid[1][0]=='o' && grid[1][2]=='o' ||
                grid[1][1]=='o' && grid[0][1]=='o' && grid[2][1]=='o' ||
                grid[1][1]=='o' && grid[0][0]=='o' && grid[2][2]=='o' ||
                grid[1][1]=='o' && grid[0][2]=='o' && grid[2][0]=='o' ||
